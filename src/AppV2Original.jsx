...
const HERO_DIAGNOSTICS = [
  ...
  },
  {
    ...
    tone: 'ink',
    label: 'REPEAT',
    title: 'More practice papers will not fix the problem if the thinking pattern stays the same.',
    detail: 'If they approach every question with the same rushed interpretation, practice only turns the mistake into a habit.',
  },
  {
    icon: XCircle,
    tone: 'red',
    label: 'FRUSTRATION',
    title: 'More support does not always mean better exam performance.',
    detail: 'If the thinking pattern stays the same, the same marks keep slipping away.',
  },
  {
    icon: Gauge,
    tone: 'ink',
    label: 'REGRET',
    title: 'The most painful part is knowing they had the ability.',
    detail: 'They leave the exam realizing the answer was within reach, but pressure made them move too fast to structure it clearly.',
  },
];
      ...
      <div className="v2-container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="v2-card v2-hero-card">
          ...
          <h1 className="v2-hero-title v2-animate-fade-up v2-delay-100">
            Guide a capable student to improve their English exam score by <span className="v2-title-accent">+1 to +3 bands</span>
            <br />
            without doing more <span className="v2-title-accent">practice papers.</span>
          </h1>
          </div>
