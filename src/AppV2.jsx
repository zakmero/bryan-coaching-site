...
function PrimaryCTA({ className = '' }) {
  return (
    <a href="#apply" className={`v2-cta ${className}`.trim()}>
...
function SectionHeader({ eyebrow, title, subtitle }) {
  return (
    <div className="v2-section-head">
      ...
      <h2>{title}</h2>
      {subtitle ? <p className="v2-subtitle">{subtitle}</p> : null}
    </div>
  );
}
  ...
  return (
    <header className="v2-header">
      <div className="v2-container v2-header-inner">
        <a href="#home" className="v2-logo">Bryan Teng | English Exam Performance Coach</a>
        <PrimaryCTA className="v2-header-cta" />
      </div>
    </header>
  );
}
      ...
      <div className="v2-container">
        <div className="v2-hero-card">
          <div className="v2-hero-content">
            <p className="v2-eyebrow">Premium Exam Performance Coaching</p>
            <h1>
            ...
            <div className="v2-chip-row" aria-label="Exam types">
              <span>IELTS</span>
              <span>TOEFL</span>
              <span>IB</span>
              <span>A-level</span>
            ...
            <PrimaryCTA />
            <p className="v2-capacity-note">Selective intake: first 20 clients only</p>
          </div>

          <div className="v2-hero-image-wrap" aria-hidden="true">
            <img src={bryanPic} alt="" className="v2-hero-image" />
          </div>
        </div>

        <div className="v2-authority-strip" role="note" aria-label="Authority credentials">
  ...
  return (
    <section className="v2-section" id="problem">
      <div className="v2-container">
        ...
        <div className="v2-card-grid v2-grid-3">
...
function FalseBeliefSection() {
  return (
    <section className="v2-section v2-section-alt" id="belief">
      <div className="v2-container">
        <SectionHeader
        ...
        <div className="v2-card-grid v2-grid-2">
          <article className="v2-card v2-card-muted">
            <h3>Old Pattern</h3>
            <p>More papers to same thinking to same mistakes to same results</p>
          </article>
          <article className="v2-card v2-card-accent">
            <h3>New Pattern</h3>
  ...
  return (
    <section className="v2-section" id="mechanism">
      <div className="v2-container">
        ...
        <div className="v2-card-grid v2-grid-4">
          <article className="v2-card">
            <ScanSearch size={22} />
            <h3>Pause</h3>
...
function HowItWorksSection() {
  return (
    <section className="v2-section v2-section-alt" id="how-it-works">
      <div className="v2-container">
        <SectionHeader
...
function TimelineSection() {
  return (
    <section className="v2-section" id="timeline">
      <div className="v2-container">
        <SectionHeader
...
function AuthoritySection() {
  return (
    <section className="v2-section v2-section-alt" id="authority">
      <div className="v2-container">
        <SectionHeader
          eyebrow="6. Authority"
...
function OfferSection() {
  return (
    <section className="v2-section" id="offer">
      <div className="v2-container">
        <SectionHeader
        ...
        <div className="v2-card-grid v2-grid-2">
          ...
          <article className="v2-card">
            ...
            <div className="v2-flow-row" aria-label="Application flow">
              <span>Application</span>
              <span>Call</span>
              <span>Enrollment</span>
            </div>
            <p className="v2-capacity-note">Capacity is capped at the first 20 clients.</p>
          </article>
        </div>

        <div className="v2-offer-cta-wrap">
          <PrimaryCTA />
        </div>
      </div>
    </section>
...
function QualificationSection() {
  return (
    <section className="v2-section v2-section-alt" id="qualification">
      <div className="v2-container">
        <SectionHeader
    ...
    <section className="v2-section" id="apply">
      <div className="v2-container">
        <div className="v2-final-cta">
          <p className="v2-eyebrow">9. Final Step</p>
